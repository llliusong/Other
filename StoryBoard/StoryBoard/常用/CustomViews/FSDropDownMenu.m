...
- (instancetype)initWithOrigin:(CGPoint)origin andHeight:(CGFloat)height{
    ...
    if (self) {
        ...
        //tableView init
        _leftTableView = [[UITableView alloc] initWithFrame:CGRectMake(origin.x + ScreenWidth*0.3, self.frame.origin.y + self.frame.size.height, ScreenWidth*0.7, 0) style:UITableViewStylePlain];
        _leftTableView.rowHeight = 38;
        _leftTableView.dataSource = self;
        _leftTableView.delegate = self;
        
        
        _rightTableView = [[UITableView alloc] initWithFrame:CGRectMake(origin.x, self.frame.origin.y + self.frame.size.height, ScreenWidth*0.3, 0) style:UITableViewStylePlain];
...
//                self.transformView.transform = CGAffineTransformMakeTranslation(-ScreenWidth, 0);
            }
        } completion:^(BOOL finished) {
