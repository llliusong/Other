...
+ (void)segmentationView:(UIView *)view{
    ...
    topview.backgroundColor = [UIColor colorWithRed:200.0/255.0 green:200.0/255.0 blue:200.0/255.0 alpha:1.0];
    [view addSubview:topview];
    
    UIView *bottmview = [[UIView alloc] initWithFrame:CGRectMake(0, 9.5, SCREEN_WIDTH, 0.5)];
    bottmview.backgroundColor = [UIColor colorWithRed:200.0/255.0 green:200.0/255.0 blue:200.0/255.0 alpha:1.0];
...
+(void)setBottom:(NSArray *)viewArr{
    ...
    for (int i = 0; i<viewArr.count; i++) {
        ...
        UIView *bottomview = [[UIView alloc] initWithFrame:CGRectMake(0, view.frame.size.height-0.7, [[UIScreen mainScreen] bounds].size.width, 0.7)];
